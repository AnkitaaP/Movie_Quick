...
public class Movie {
     ...
     */
    public Movie(int movieId, String title, String posterPath, String backDropPath, Integer runTime, double rating, String overview, String releaseDate, ArrayList<String> genres, ArrayList<String> productionCompanies, ArrayList<Cast> cast, String trailerId) {
        this.movieId = movieId;
        this.title = title;
